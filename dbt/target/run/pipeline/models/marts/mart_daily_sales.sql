        ...
        insert into `mart`.`mart_daily_sales__dbt_backup`
        ("order_date", "category", "total_orders", "total_revenue", "avg_order_value")-- Pre-aggregated rollup so dashboards hit a small table instead of
